      ...
      <Box sx={{ bgcolor: 'background.default', minHeight: '80vh', display: 'flex', alignItems: 'center' }}>
        <Container maxWidth="sm" sx={{ textAlign: 'center', py: 8 }}>
          ...
          <Typography color="text.secondary" sx={{ mb: 3 }}>
            Thank you for reaching out. We'll get back to you at <strong>{email}</strong> as soon as possible, usually within 1-2 business days.
          </Typography>
          <Button variant="contained" onClick={() => { setSuccess(false); setMessage(''); setSubject(''); }}>
          ...
          <Grid item xs={12} md={4}>
                ...
                <Stack spacing={2}>
                  <Box sx={{ display: 'flex', gap: 1.5 }}>
                    ...
                    <Box>
                      ...
                      <Typography variant="body2" color="text.secondary">support@studyspace.com</Typography>
                    </Box>
                  </Box>
                  <Box sx={{ display: 'flex', gap: 1.5 }}>
                    ...
                    <Box>
                      ...
                      <Typography variant="body2" color="text.secondary">+44 20 7815 7815</Typography>
                    </Box>
                  </Box>
                  <Box sx={{ display: 'flex', gap: 1.5 }}>
                    <LocationOn sx={{ fontSize: 20, color: 'primary.main', mt: 0.25 }} />
                    <Box>
            ...
            <Card>
              <CardContent>
                ...
                <Typography variant="body2" color="text.secondary">
                  We aim to respond to all enquiries within 1-2 business days. For urgent account issues, please include your registered email address.
                </Typography>
              </CardContent>
            </Card>
          </Grid>
